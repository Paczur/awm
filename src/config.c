...
F_DEF(volume_up, c_run("volume +"); c_bar_block_update_highlight(1, 1);)
F_DEF(volume_down, c_run("volume -"); c_bar_block_update_highlight(1, 1);)
F_DEF(brightness_down, c_run("xbacklight -dec 2"); c_bar_block_update_highlight(3, 1);)
F_DEF(brightness_up, c_run("xbacklight -inc 2"); c_bar_block_update_highlight(3, 1);)
...
F_DEF(screenshot,
      c_run("scrot -s -q 100 -e "
            "\"xclip -selection clipboard -t image/png -i "
            "/home/paczur/Multimedia/Pictures/Screenshots/Scrot/%d-%m-%Y_%H-%M-%S_$wx$h.png\" "
            "/home/paczur/Multimedia/Pictures/Screenshots/Scrot/%d-%m-%Y_%H-%M-%S_$wx$h.png");)
