...
void block_redraw_batch(const block_t*, size_t);
...
void block_geometry_update_center(block_t*, block_geometry_t*, bool*, size_t,
                                  size_t, const block_settings_t*(*)(size_t),
                                  uint16_t, uint16_t, uint16_t);

void block_geometry_update_rightef(block_t*, block_geometry_t*, bool*, size_t,
                                   const block_settings_t*(*)(size_t),
                                   uint16_t);
...
void block_hide(block_t*);
void block_show(block_t*);

void block_create(block_t*, xcb_window_t, const PangoFontDescription*);
